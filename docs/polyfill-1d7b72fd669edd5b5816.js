            ...
            (function (t) {
                !(function () {
                    ...
                    var Q,
                        ...
                        wt = function (t, e) {
                            for (let r = St(e), n = _.f, o = A.f, i = 0; i < r.length; i++) {
                                const a = r[i];
                                S(t, a) || n(t, a, o(e, a));
                            }
                        },
                        ...
                        Dt = function (t) {
                            return (
                                S(Ut, t) || (Ut[t] = Nt && S(Ct, t) ? Ct[t] : Ft("Symbol." + t)),
                                Ut[t]
                            );
                        },
                        Bt =
                    ...
                    Tt({ target: "Array", proto: !0 }, { copyWithin: kt }), Yt("copyWithin");
                    const Jt = function (t) {
                    ...
                    const _e = { IteratorPrototype: me, BUGGY_SAFARI_ITERATORS: Pe },
                        Te = _.f,
                        Ie = Dt("toStringTag"),
                        Me = function (t, e, r) {
                            t &&
                    ...
                    Tt({ target: "Map", proto: !0, real: !0, forced: !1 }, { upsert: Yr }),
                    Tt(
                        { target: "Map", proto: !0, real: !0, forced: !1 },
                        { updateOrInsert: Yr },
                    );
                    ...
                    cn.prototype = {
                        ...
                        delete: function (t) {
                            const e = on(this.entries, function (e) {
                                return e[0] === t;
                            });
                    ...
                    Tt({ target: "WeakMap", proto: !0, real: !0, forced: !1 }, { upsert: Yr }),
                    Ar(
                        "WeakSet",
                        function (t) {
                            return function () {
                    ...
                    Tt({ target: "Number", stat: !0 }, { MAX_SAFE_INTEGER: 9007199254740991 }),
                    Tt({ target: "Number", stat: !0 }, { MIN_SAFE_INTEGER: -9007199254740991 });
                    const Nn = s.f,
                        Ln = function (t) {
                            return function (e) {
                                for (
                    ...
                    const so = A.f,
                        ...
                        ho =
                            !po &&
                            !!(function () {
                                const t = so(String.prototype, "startsWith");
                                return t && !t.writable;
                            })();
                    Tt(
                    ...
                    const bo = yn.end,
                        ...
                        wo = So
                            ...
                            : "".trimEnd;
                    Tt({ target: "String", proto: !0, forced: So }, { trimEnd: wo, trimRight: wo }),
                    te("String", "trimRight");
                    const Eo = nt("Reflect", "apply"),
                        xo = Function.apply,
                        Oo = !i(function () {
                            Eo(function () {});
                        });
                        ...
                        Po =
                            ...
                            function (t) {
                                var e = Jt(this),
                                    ...
                                    n = function () {
                                        const o = r.concat(jo.call(arguments));
                    ...
                    Tt(
                        { target: "Reflect", stat: !0 },
                        {
                            defineMetadata: function (t, e, r) {
                                const n = arguments.length < 4 ? void 0 : Wo(arguments[3]);
                                zo(t, e, R(r), n);
                            },
                        },
                    );
                    ...
                    Tt(
                        { target: "Reflect", stat: !0 },
                        {
                            deleteMetadata: function (t, e) {
                                const r = arguments.length < 3 ? void 0 : Ko(arguments[2]),
                                    n = Go(R(e), r, !1);
                    ...
                    Tt(
                        { target: "Reflect", stat: !0 },
                        {
                            getMetadata: function (t, e) {
                                const r = arguments.length < 3 ? void 0 : Ho(arguments[2]);
                                return Xo(t, R(e), r);
                            },
                        },
                    );
                    ...
                    Tt(
                        { target: "Reflect", stat: !0 },
                        {
                            getMetadataKeys: function (t) {
                                const e = arguments.length < 2 ? void 0 : Jo(arguments[1]);
                                return Qo(R(t), e);
                            },
                        },
                    );
                    ...
                    Tt(
                        { target: "Reflect", stat: !0 },
                        {
                            getOwnMetadata: function (t, e) {
                                const r = arguments.length < 3 ? void 0 : ti(arguments[2]);
                                return Zo(t, R(e), r);
                            },
                        },
                    );
                    ...
                    Tt(
                        { target: "Reflect", stat: !0 },
                        {
                            getOwnMetadataKeys: function (t) {
                                const e = arguments.length < 2 ? void 0 : ri(arguments[1]);
                                return ei(R(t), e);
                            },
                        },
                    );
                    ...
                    Tt(
                        { target: "Reflect", stat: !0 },
                        {
                            hasMetadata: function (t, e) {
                                const r = arguments.length < 3 ? void 0 : oi(arguments[2]);
                                return ii(t, R(e), r);
                            },
                        },
                    );
                        ...
                        for (
                            var xi = function (t, e) {
                                    ...
                                    Ei &&
                                            (r = !!e && e.indexOf("y") > -1) &&
                                            (e = e.replace(/y/g, ""));
                                    const a = jr(wi ? new yi(t, e) : yi(t, e), n ? this : mi, xi);
                    ...
                    const Li = Ii;
                    Tt({ target: "RegExp", proto: !0, forced: /./.exec !== Li }, { exec: Li }),
                    a &&
                                    ...
                                    function (t, o) {
                                        ...
                                        for (var p = 0, h = 0, d = []; h < u.length; ) {
                                            ...
                                            if (
                                                null === g ||
                                                (v = oa(
                                                    ct(f.lastIndex + (ia ? 0 : h)),
                                                    u.length,
                                                )) === p
                                            )
                                                h = Yi(u, h, s);
                                            else {
                                                if ((d.push(u.slice(p, h)), d.length === l))
                                                    return d;
                    ...
                    var ya = mt.f,
                        ...
                        Ha = function (t) {
                            ...
                            return (
                                ...
                                (!(r || !S(this, e) || !S(Ua, e) || (S(this, ja) && this[ja][e])) ||
                                    r)
                            );
                        },
                        Xa = function (t, e) {
                    ...
                    if (
                        ...
                        Tt({ global: !0, wrap: !0, forced: !Nt, sham: !Nt }, { Symbol: Ta }),
                        Oa(Bt(Ba), function (t) {
                            xa(t);
                        }),
                        Tt(
                    ...
                    if (
                        ...
                        wt(ru, tu);
                        const nu = (ru.prototype = tu.prototype);
                        nu.constructor = ru;
                        const ou = nu.toString,
                        ...
                        Za(nu, "description", {
                            ...
                            get: function () {
                                const t = y(this) ? this.valueOf() : this,
                                    e = ou.call(t);
                                if (S(eu, t)) return "";
                                const r = iu ? e.slice(7, -1) : e.replace(au, "$1");
                                return "" === r ? void 0 : r;
                            },
                        }),
                    ...
                    var Wu,
                        ...
                        dc = function (t, e, r) {
                            if (!e.notified) {
                                ...
                                const n = e.reactions;
                                Vu(function () {
                                    for (let o = e.value, i = 1 == e.state, a = 0; n.length > a; ) {
                                        var u,
                                            c,
                                            s,
                                            f = n[a++],
                    ...
                    var xc = Z.set,
                        ...
                        jc = function (t, e) {
                            ...
                            return (
                                xr(t, n.push, n),
                                a ? xc(r, { errors: n, type: "AggregateError" }) : (r.errors = n),
                    ...
                    const Ac = "URLSearchParams" in self,
                                        ...
                                        : Pc && Blob.prototype.isPrototypeOf(t)
                                            ...
                                            : _c && FormData.prototype.isPrototypeOf(t)
                                              ...
                                              DataView.prototype.isPrototypeOf(e)
                                                        ...
                                                        : Tc &&
                                              (ArrayBuffer.prototype.isPrototypeOf(t) || Mc(t))
                    ...
                    const zc = ["DELETE", "GET", "HEAD", "OPTIONS", "POST", "PUT"];
                    function Kc(t, e) {
                        let r,
                            n,
                            o = (e = e || {}).body;
                    ...
                    (Vc.error = function () {
                        const t = new Vc(null, { status: 0, statusText: "" });
                    ...
                    const Xc = Object.getOwnPropertySymbols,
